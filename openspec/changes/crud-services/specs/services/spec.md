...
None — the change expands an existing capability rather than adding a
new one. The new behavior is fully described by the modified
requirements above.

## REMOVED Requirements

None. The previously-shipped `GET /api/v1/services` listing endpoint
remains unchanged.
